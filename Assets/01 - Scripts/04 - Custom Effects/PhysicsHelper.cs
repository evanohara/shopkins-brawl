...
public static class PhysicsHelper
{
    ...
    public static void ApplyForceToReachVelocityWhileInContact(Rigidbody2D rigidbody, Vector2 velocity, float force = 1)
    {
        if (force == 0 || velocity.magnitude == 0)
            return;
        ...
        else
        {
            ...
            rigidbody.AddForce((velocity - velocityProjectedToTarget) * force);
        }
    }
